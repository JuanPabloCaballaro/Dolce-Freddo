# Generated by Django 5.1.7 on 2025-07-08 11:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gustos', models.CharField(help_text='Separar los gustos por coma', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Envio',
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('en_camino', 'En camino'), ('entregado', 'Entregado')], default='pendiente', max_length=15)),
